...
if __name__ == '__main__':
    ...
    info.add_blind_region(Box.from_tlbr(np.array([1346,-2,1512,188])))
    info.add_blind_region(Box.from_tlbr(np.array([655,-2,1357,67])))
    camera_infos.insert(info)
    info = CameraInfo(camera_id='cross:11', uri="C:/Temp/data/cross_11.mp4", size=Size2i(1920, 1080), fps=15)
    info.add_blind_region(Box.from_tlbr(np.array([501,-3,1573,236])))
    camera_infos.insert(info)
    info = CameraInfo(camera_id='cross:21', uri="C:/Temp/data/cross_21.mp4", size=Size2i(1920, 1080), fps=15)
    info.add_blind_region(Box.from_tlbr(np.array([501,-3,1573,236])))
    camera_infos.insert(info)
    info = CameraInfo(camera_id='cross:22', uri="C:/Temp/data/cross_22.mp4", size=Size2i(1920, 1080), fps=15)
    info.add_blind_region(Box.from_tlbr(np.array([464,-2,1479,144])))
    camera_infos.insert(info)
    info = CameraInfo(camera_id='cross:23', uri="C:/Temp/data/cross_23.mp4", size=Size2i(1920, 1080), fps=15)
